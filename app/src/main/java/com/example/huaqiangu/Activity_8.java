...
public class Activity_8 extends Activity {
	...
	class MyButtonListener implements OnClickListener{
		...
		public void onClick(View v){
			if(v.getId()==R.id.btn_1){
					...
					intent.setClass(Activity_8.this, Video_5.class);
					Activity_8.this.startActivity(intent);
					Activity_8.this.finish();
			}
			if(v.getId()==R.id.btn_2){
				Intent intent = new Intent();
				intent.setClass(Activity_8.this, Video_4.class);
				Activity_8.this.startActivity(intent);
				Activity_8.this.finish();
			}
